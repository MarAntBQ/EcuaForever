   ...
   <div class="page-section contact-page">
    ...
    <div class="flex-hc">
        <div class="box-4 box-m-6 box-p-12 contact-box tac" data-aos="zoom-in" data-aos-duration="800">
            ...
            <h2>Dirección</h2>
            <p class="service-about">ECUAFOREVER E8-381 Av. Ilaló.<br><strong>Quito - Ecuador, CA 94158</strong></p>
        </div>
        <div class="box-4 box-m-6 box-p-12 contact-box tac" data-aos="zoom-in" data-aos-duration="800">
            <div class="icon-ctnr">
        ...
        <div class="box-4 box-m-6 box-p-12 contact-box tac" data-aos="zoom-in" data-aos-duration="800">
            ...
            <h2>Teléfono</h2>
            <a href="<?php echo $PHLink;?>"><strong>+593 (98) 638 - 1050</strong></a>
            <a href="<?php echo $PHLink2;?>"><strong>+593 (02) 234 - 9595</strong></a>
        </div>
    </div>
</div>
